...
<body>
<h2  class="p-2 mb-2 bg-danger text-white"><input type="submit" align="rigth" value="INICIO" class="btn btn-danger" onclick = "location='../views/principal.php/'"/> REGISTRO DE APODERADOS</h2>
